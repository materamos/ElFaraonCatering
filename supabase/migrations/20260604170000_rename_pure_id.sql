...
do $$
declare
  old_item_id constant text := 'pure-papa';
  new_item_id constant text := 'pure';
  old_pricing_key constant text := 'catalog:guarniciones:item:pure-papa:price';
  new_pricing_key constant text := 'catalog:guarniciones:item:pure:price';
begin
  if exists (
    select 1
