-- Prelaunch handoff baseline generated from the final production-equivalent state.
--
-- This single atomic migration is the canonical entrypoint for new databases.
-- It declares the final schema, RPCs, grants, RLS, build-time menu_content data,
-- and empty operational tables without replaying the pre-squash migration history.
--
...
-- -----------------------------------------------------------------------------
-- Final schema, functions, permissions, and policies
-- -----------------------------------------------------------------------------
...
ALTER SCHEMA "menu_content" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "app_private"."add_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text", "amount" integer) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
...
ALTER FUNCTION "app_private"."add_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text", "amount" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."add_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $_$
declare
...
ALTER FUNCTION "app_private"."add_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."add_grill_item"("family_id" "text", "item_id" "text", "name" "text", "variant_name" "text", "amount" integer) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $_$
declare
...
ALTER FUNCTION "app_private"."add_grill_item"("family_id" "text", "item_id" "text", "name" "text", "variant_name" "text", "amount" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."add_grill_product"("family_id" "text", "title" "text", "item_id" "text", "variant_name" "text", "amount" integer) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $_$
declare
...
ALTER FUNCTION "app_private"."add_grill_product"("family_id" "text", "title" "text", "item_id" "text", "variant_name" "text", "amount" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."can_edit_availability"("target_profile_id" "text") RETURNS boolean
...
ALTER FUNCTION "app_private"."can_edit_availability"("target_profile_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."can_edit_menu_content"() RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
  select exists (
...
ALTER FUNCTION "app_private"."can_edit_menu_content"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."can_manage_staff"() RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
  select exists (
...
ALTER FUNCTION "app_private"."can_manage_staff"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."can_publish_menu"() RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
  select exists (
...
ALTER FUNCTION "app_private"."can_publish_menu"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."clear_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."clear_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."clear_menu_availability_overlays"("targets" "jsonb") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."clear_menu_availability_overlays"("targets" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."delete_catalog_item"("section_id" "text", "item_id" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."delete_catalog_item"("section_id" "text", "item_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."delete_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."delete_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."delete_grill_item"("item_id" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."delete_grill_item"("item_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."delete_grill_product"("family_id" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."delete_grill_product"("family_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."generate_admin_id"("prefix" "text") RETURNS "text"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
ALTER FUNCTION "app_private"."generate_admin_id"("prefix" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."get_admin_catalog_editor_state"() RETURNS "jsonb"
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
  select case
...
ALTER FUNCTION "app_private"."get_admin_catalog_editor_state"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."get_admin_grill_editor_state"() RETURNS "jsonb"
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
...
ALTER FUNCTION "app_private"."get_admin_grill_editor_state"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."get_admin_operational_state"() RETURNS "jsonb"
...
ALTER FUNCTION "app_private"."get_admin_operational_state"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."get_menu_publication_content_hash"() RETURNS "text"
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
  with content as (
...
ALTER FUNCTION "app_private"."get_menu_publication_content_hash"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."get_menu_publication_state"() RETURNS "jsonb"
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
...
ALTER FUNCTION "app_private"."get_menu_publication_state"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "app_private"."menu_availability_target_exists"("target_menu_id" "text", "target_section_id" "text", "target_item_id" "text") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
  select exists (
...
ALTER FUNCTION "app_private"."menu_availability_target_exists"("target_menu_id" "text", "target_section_id" "text", "target_item_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."normalize_visible_name"("value" "text") RETURNS "text"
...
ALTER FUNCTION "app_private"."normalize_visible_name"("value" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."record_menu_change_event"("change_operation" "text", "operation_input" "jsonb", "result_message" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $_$
declare
...
ALTER FUNCTION "app_private"."record_menu_change_event"("change_operation" "text", "operation_input" "jsonb", "result_message" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."set_daily_menu"("regular_name" "text", "regular_description" "text", "vegetarian_name" "text", "vegetarian_description" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."set_daily_menu"("regular_name" "text", "regular_description" "text", "vegetarian_name" "text", "vegetarian_description" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."set_global_fixed_price"("pricing_key" "text", "amount" integer) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."set_global_fixed_price"("pricing_key" "text", "amount" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."set_global_price_variant"("pricing_key" "text", "variant_id" "text", "amount" integer) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."set_global_price_variant"("pricing_key" "text", "variant_id" "text", "amount" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."set_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text", "available_override" boolean) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."set_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text", "available_override" boolean) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."set_menu_availability_overlays"("targets" "jsonb", "available_override" boolean) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."set_menu_availability_overlays"("targets" "jsonb", "available_override" boolean) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."set_profile_service_kind"("profile_id" "text", "service_kind" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."set_profile_service_kind"("profile_id" "text", "service_kind" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."update_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."update_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."update_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."update_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."update_grill_item"("item_id" "text", "name" "text", "variant_name" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."update_grill_item"("item_id" "text", "name" "text", "variant_name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "app_private"."update_grill_product"("family_id" "text", "title" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "app_private"."update_grill_product"("family_id" "text", "title" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."add_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text", "amount" integer) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
...
ALTER FUNCTION "public"."add_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text", "amount" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."add_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
declare
...
ALTER FUNCTION "public"."add_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."add_grill_item"("family_id" "text", "item_id" "text", "name" "text", "variant_name" "text", "amount" integer) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
declare
...
ALTER FUNCTION "public"."add_grill_item"("family_id" "text", "item_id" "text", "name" "text", "variant_name" "text", "amount" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."add_grill_product"("family_id" "text", "title" "text", "item_id" "text", "variant_name" "text", "amount" integer) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
declare
...
ALTER FUNCTION "public"."add_grill_product"("family_id" "text", "title" "text", "item_id" "text", "variant_name" "text", "amount" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."can_edit_availability"("target_profile_id" "text") RETURNS boolean
    LANGUAGE "sql" STABLE
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
...
ALTER FUNCTION "public"."can_edit_availability"("target_profile_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."can_edit_menu_content"() RETURNS boolean
    LANGUAGE "sql" STABLE
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $$
...
ALTER FUNCTION "public"."can_edit_menu_content"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."can_manage_staff"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."can_publish_menu"() RETURNS boolean
    LANGUAGE "sql" STABLE
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $$
...
ALTER FUNCTION "public"."can_publish_menu"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."clear_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "sql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
...
ALTER FUNCTION "public"."clear_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."clear_menu_availability_overlays"("targets" "jsonb") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "sql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
...
ALTER FUNCTION "public"."clear_menu_availability_overlays"("targets" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."complete_menu_publish_request"("request_id" bigint, "publish_status" "text", "publish_message" "text", "vercel_status_code" integer, "vercel_job_id" "text") RETURNS TABLE("completed" boolean, "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "public"."complete_menu_publish_request"("request_id" bigint, "publish_status" "text", "publish_message" "text", "vercel_status_code" integer, "vercel_job_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."delete_catalog_item"("section_id" "text", "item_id" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
begin
...
ALTER FUNCTION "public"."delete_catalog_item"("section_id" "text", "item_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."delete_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
begin
...
ALTER FUNCTION "public"."delete_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."delete_grill_item"("item_id" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
begin
...
ALTER FUNCTION "public"."delete_grill_item"("item_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."delete_grill_product"("family_id" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
begin
...
ALTER FUNCTION "public"."delete_grill_product"("family_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_admin_operational_state"() RETURNS "jsonb"
    LANGUAGE "sql" STABLE
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $$
  with base_state as (
...
ALTER FUNCTION "public"."get_admin_operational_state"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."menu_availability_target_exists"("target_menu_id" "text", "target_section_id" "text", "target_item_id" "text") RETURNS boolean
    LANGUAGE "sql" STABLE
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
...
ALTER FUNCTION "public"."menu_availability_target_exists"("target_menu_id" "text", "target_section_id" "text", "target_item_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."reserve_menu_publish_request"("user_id" "uuid", "cooldown_seconds" integer) RETURNS TABLE("request_id" bigint, "reserved" boolean, "message" "text", "cooldown_remaining_seconds" integer)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "public"."reserve_menu_publish_request"("user_id" "uuid", "cooldown_seconds" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_daily_menu"("regular_name" "text", "regular_description" "text", "vegetarian_name" "text", "vegetarian_description" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
begin
...
ALTER FUNCTION "public"."set_daily_menu"("regular_name" "text", "regular_description" "text", "vegetarian_name" "text", "vegetarian_description" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_global_fixed_price"("pricing_key" "text", "amount" integer) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
begin
...
ALTER FUNCTION "public"."set_global_fixed_price"("pricing_key" "text", "amount" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_global_price_variant"("pricing_key" "text", "variant_id" "text", "amount" integer) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
begin
...
ALTER FUNCTION "public"."set_global_price_variant"("pricing_key" "text", "variant_id" "text", "amount" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text", "available_override" boolean) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "sql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
...
ALTER FUNCTION "public"."set_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text", "available_override" boolean) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_menu_availability_overlays"("targets" "jsonb", "available_override" boolean) RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "sql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
...
ALTER FUNCTION "public"."set_menu_availability_overlays"("targets" "jsonb", "available_override" boolean) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_profile_service_kind"("profile_id" "text", "service_kind" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
begin
...
ALTER FUNCTION "public"."set_profile_service_kind"("profile_id" "text", "service_kind" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_staff_users_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
begin
...
ALTER FUNCTION "public"."set_staff_users_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
begin
...
ALTER FUNCTION "public"."update_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
begin
...
ALTER FUNCTION "public"."update_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_grill_item"("item_id" "text", "name" "text", "variant_name" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
begin
...
ALTER FUNCTION "public"."update_grill_item"("item_id" "text", "name" "text", "variant_name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_grill_product"("family_id" "text", "title" "text") RETURNS TABLE("ok" boolean, "changed" boolean, "requires_redeploy" boolean, "operation" "text", "message" "text")
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'app_private', 'pg_temp'
    AS $_$
begin
...
ALTER FUNCTION "public"."update_grill_product"("family_id" "text", "title" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "app_private"."menu_change_events" (
    "id" bigint NOT NULL,
    ...
    CONSTRAINT "menu_change_events_menu_content_hash_check" CHECK ((("menu_content_hash" IS NULL) OR ("menu_content_hash" ~ '^[a-f0-9]{32}$'::"text"))),
    CONSTRAINT "menu_change_events_operation_check" CHECK ((("operation" ~ '^[a-z0-9_]+$'::"text") AND ("length"("operation") <= 80))),
    CONSTRAINT "menu_change_events_operation_input_check" CHECK (("jsonb_typeof"("operation_input") = 'object'::"text")),
    CONSTRAINT "menu_change_events_result_message_check" CHECK ((("length"("btrim"("result_message")) > 0) AND ("length"("result_message") <= 120)))
);


ALTER TABLE "app_private"."menu_change_events" OWNER TO "postgres";


ALTER TABLE "app_private"."menu_change_events" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "app_private"."menu_change_events_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "app_private"."menu_publish_requests" (
    ...
    CONSTRAINT "menu_publish_requests_change_event_count_check" CHECK (("change_event_count" >= 0)),
    CONSTRAINT "menu_publish_requests_menu_content_hash_valid" CHECK ((("menu_content_hash" IS NULL) OR ("menu_content_hash" ~ '^[a-f0-9]{32}$'::"text"))),
    CONSTRAINT "menu_publish_requests_message_check" CHECK ((("length"("btrim"("message")) > 0) AND ("length"("message") <= 120))),
    CONSTRAINT "menu_publish_requests_status_check" CHECK (("status" = ANY (ARRAY['queued'::"text", 'cooldown'::"text", 'succeeded'::"text", 'failed'::"text"]))),
    CONSTRAINT "menu_publish_requests_vercel_job_id_check" CHECK ((("vercel_job_id" IS NULL) OR ("length"("btrim"("vercel_job_id")) > 0))),
    CONSTRAINT "menu_publish_requests_vercel_status_code_check" CHECK ((("vercel_status_code" IS NULL) OR (("vercel_status_code" >= 100) AND ("vercel_status_code" <= 599))))
);


ALTER TABLE "app_private"."menu_publish_requests" OWNER TO "postgres";


ALTER TABLE "app_private"."menu_publish_requests" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "app_private"."menu_publish_requests_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "menu_content"."menu_catalog_item_images" (
    ...
    CONSTRAINT "menu_catalog_item_images_image_path_check" CHECK (("length"("btrim"("image_path")) > 0)),
    CONSTRAINT "menu_catalog_item_images_order_index_check" CHECK (("order_index" >= 0)),
    CONSTRAINT "menu_catalog_item_images_path_valid" CHECK ((("image_path" ~~ '/uploads/%'::"text") AND ("image_path" !~~ '%//%'::"text") AND ("image_path" !~~ '%\%'::"text") AND ("image_path" !~~ '%?%'::"text") AND ("image_path" !~~ '%#%'::"text") AND ("image_path" !~ '(^|/)\.\.?(/|$)'::"text") AND ("lower"("image_path") ~ '\.(avif|jpeg|jpg|png|svg|webp)$'::"text")))
);


ALTER TABLE "menu_content"."menu_catalog_item_images" OWNER TO "postgres";


ALTER TABLE "menu_content"."menu_catalog_item_images" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "menu_content"."menu_catalog_item_images_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "menu_content"."menu_catalog_item_options" (
    ...
    "order_index" integer NOT NULL,
    CONSTRAINT "menu_catalog_item_options_name_check" CHECK (("length"("btrim"("name")) > 0)),
    CONSTRAINT "menu_catalog_item_options_option_id_check" CHECK (("option_id" ~ '^[a-z0-9]+(?:-[a-z0-9]+)*$'::"text")),
    CONSTRAINT "menu_catalog_item_options_order_index_check" CHECK (("order_index" >= 0))
);


ALTER TABLE "menu_content"."menu_catalog_item_options" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "menu_content"."menu_catalog_items" (
    ...
    "order_index" integer NOT NULL,
    CONSTRAINT "menu_catalog_items_item_id_check" CHECK (("item_id" ~ '^[a-z0-9]+(?:-[a-z0-9]+)*$'::"text")),
    CONSTRAINT "menu_catalog_items_name_check" CHECK (("length"("btrim"("name")) > 0)),
    CONSTRAINT "menu_catalog_items_order_index_check" CHECK (("order_index" >= 0))
);


ALTER TABLE "menu_content"."menu_catalog_items" OWNER TO "postgres";


ALTER TABLE "menu_content"."menu_catalog_items" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "menu_content"."menu_catalog_items_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "menu_content"."menu_catalog_sections" (
    ...
    "description" "text",
    "order_index" integer NOT NULL,
    "presentation" "text" DEFAULT 'cards'::"text" NOT NULL,
    CONSTRAINT "menu_catalog_sections_order_index_check" CHECK (("order_index" >= 0)),
    CONSTRAINT "menu_catalog_sections_presentation_check" CHECK (("presentation" = ANY (ARRAY['cards'::"text", 'compact-list'::"text"]))),
    CONSTRAINT "menu_catalog_sections_section_id_check" CHECK (("section_id" ~ '^[a-z0-9]+(?:-[a-z0-9]+)*$'::"text")),
    CONSTRAINT "menu_catalog_sections_title_check" CHECK (("length"("btrim"("title")) > 0))
);


ALTER TABLE "menu_content"."menu_catalog_sections" OWNER TO "postgres";


ALTER TABLE "menu_content"."menu_catalog_sections" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "menu_content"."menu_catalog_sections_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "menu_content"."menu_daily_items" (
    ...
    "pricing_key" "text" NOT NULL,
    "order_index" integer NOT NULL,
    CONSTRAINT "menu_daily_items_item_id_check" CHECK (("item_id" ~ '^[a-z0-9]+(?:-[a-z0-9]+)*$'::"text")),
    CONSTRAINT "menu_daily_items_name_check" CHECK (("length"("btrim"("name")) > 0)),
    CONSTRAINT "menu_daily_items_order_index_check" CHECK (("order_index" >= 0))
);


ALTER TABLE "menu_content"."menu_daily_items" OWNER TO "postgres";


ALTER TABLE "menu_content"."menu_daily_items" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "menu_content"."menu_daily_items_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "menu_content"."menu_grill_catalog_items" (
    ...
    "order_index" integer NOT NULL,
    "variant_name" "text",
    CONSTRAINT "menu_grill_catalog_items_item_id_check" CHECK (("item_id" ~ '^[a-z0-9]+(?:-[a-z0-9]+)*$'::"text")),
    CONSTRAINT "menu_grill_catalog_items_name_check" CHECK (("length"("btrim"("name")) > 0)),
    CONSTRAINT "menu_grill_catalog_items_order_index_check" CHECK (("order_index" >= 0))
);


ALTER TABLE "menu_content"."menu_grill_catalog_items" OWNER TO "postgres";


ALTER TABLE "menu_content"."menu_grill_catalog_items" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "menu_content"."menu_grill_catalog_items_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "menu_content"."menu_grill_families" (
    ...
    "title" "text" NOT NULL,
    "order_index" integer NOT NULL,
    CONSTRAINT "menu_grill_families_family_id_check" CHECK (("family_id" ~ '^[a-z0-9]+(?:-[a-z0-9]+)*$'::"text")),
    CONSTRAINT "menu_grill_families_order_index_check" CHECK (("order_index" >= 0)),
    CONSTRAINT "menu_grill_families_title_check" CHECK (("length"("btrim"("title")) > 0))
);


ALTER TABLE "menu_content"."menu_grill_families" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "menu_content"."menu_price_variants" (
    "pricing_key" "text" NOT NULL,
    "price_kind" "text" DEFAULT 'variants'::"text" NOT NULL,
    "variant_id" "text" NOT NULL,
    "name" "text" NOT NULL,
    "amount" integer NOT NULL,
    "available" boolean DEFAULT true NOT NULL,
    "order_index" integer NOT NULL,
    CONSTRAINT "menu_price_variants_amount_check" CHECK (("amount" >= 0)),
    CONSTRAINT "menu_price_variants_name_check" CHECK (("length"("btrim"("name")) > 0)),
    CONSTRAINT "menu_price_variants_order_index_check" CHECK (("order_index" >= 0)),
    CONSTRAINT "menu_price_variants_price_kind_check" CHECK (("price_kind" = 'variants'::"text")),
    CONSTRAINT "menu_price_variants_variant_id_check" CHECK (("variant_id" ~ '^[a-z0-9]+(?:-[a-z0-9]+)*$'::"text"))
);


ALTER TABLE "menu_content"."menu_price_variants" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "menu_content"."menu_prices" (
    ...
    "kind" "text" NOT NULL,
    "amount" integer,
    CONSTRAINT "menu_prices_amount_check" CHECK ((("amount" IS NULL) OR ("amount" >= 0))),
    CONSTRAINT "menu_prices_kind_amount_valid" CHECK (((("kind" = 'fixed'::"text") AND ("amount" IS NOT NULL)) OR (("kind" = ANY (ARRAY['included'::"text", 'variants'::"text"])) AND ("amount" IS NULL)))),
    CONSTRAINT "menu_prices_kind_check" CHECK (("kind" = ANY (ARRAY['fixed'::"text", 'included'::"text", 'variants'::"text"]))),
    CONSTRAINT "menu_prices_pricing_key_check" CHECK (("length"("btrim"("pricing_key")) > 0))
);


ALTER TABLE "menu_content"."menu_prices" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "menu_content"."menu_profile_facts" (
    ...
    "link_href" "text",
    "order_index" integer NOT NULL,
    CONSTRAINT "menu_profile_facts_fact_id_check" CHECK (("fact_id" ~ '^[a-z0-9]+(?:-[a-z0-9]+)*$'::"text")),
    CONSTRAINT "menu_profile_facts_label_check" CHECK (("length"("btrim"("label")) > 0)),
    CONSTRAINT "menu_profile_facts_link_pair_valid" CHECK (((("link_text" IS NULL) AND ("link_href" IS NULL)) OR (("link_text" IS NOT NULL) AND ("link_href" IS NOT NULL)))),
    CONSTRAINT "menu_profile_facts_order_index_check" CHECK (("order_index" >= 0)),
    CONSTRAINT "menu_profile_facts_value_check" CHECK (("length"("btrim"("value")) > 0))
);


ALTER TABLE "menu_content"."menu_profile_facts" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "menu_content"."menu_profile_service_settings" (
    "profile_id" "text" NOT NULL,
    "service_kind" "text" NOT NULL,
    CONSTRAINT "menu_profile_service_settings_service_kind_check" CHECK (("service_kind" = ANY (ARRAY['daily-menu'::"text", 'grill'::"text"])))
);


ALTER TABLE "menu_content"."menu_profile_service_settings" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "menu_content"."menu_profiles" (
    ...
    CONSTRAINT "menu_profiles_description_check" CHECK (("length"("btrim"("description")) > 0)),
    CONSTRAINT "menu_profiles_eyebrow_check" CHECK (("length"("btrim"("eyebrow")) > 0)),
    CONSTRAINT "menu_profiles_id_check" CHECK (("id" ~ '^[a-z0-9]+(?:-[a-z0-9]+)*$'::"text")),
    CONSTRAINT "menu_profiles_info_title_check" CHECK (("length"("btrim"("info_title")) > 0)),
    CONSTRAINT "menu_profiles_title_check" CHECK (("length"("btrim"("title")) > 0))
);


ALTER TABLE "menu_content"."menu_profiles" OWNER TO "postgres";
...
ALTER TABLE "public"."menu_availability_overlays" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."staff_users" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "default_availability_profile_id" "text",
    CONSTRAINT "staff_users_display_name_check" CHECK (("length"("btrim"("display_name")) > 0)),
    CONSTRAINT "staff_users_role_check" CHECK (("role" = ANY (ARRAY['operator'::"text", 'admin'::"text"])))
);
...
ALTER TABLE ONLY "app_private"."menu_change_events"
    ADD CONSTRAINT "menu_change_events_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "app_private"."menu_publish_requests"
    ADD CONSTRAINT "menu_publish_requests_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "menu_content"."menu_catalog_item_images"
    ADD CONSTRAINT "menu_catalog_item_images_catalog_item_id_image_path_key" UNIQUE ("catalog_item_id", "image_path");



ALTER TABLE ONLY "menu_content"."menu_catalog_item_images"
    ADD CONSTRAINT "menu_catalog_item_images_catalog_item_id_order_index_key" UNIQUE ("catalog_item_id", "order_index");



ALTER TABLE ONLY "menu_content"."menu_catalog_item_images"
    ADD CONSTRAINT "menu_catalog_item_images_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "menu_content"."menu_catalog_item_options"
    ADD CONSTRAINT "menu_catalog_item_options_catalog_item_id_order_index_key" UNIQUE ("catalog_item_id", "order_index");



ALTER TABLE ONLY "menu_content"."menu_catalog_item_options"
    ADD CONSTRAINT "menu_catalog_item_options_pkey" PRIMARY KEY ("catalog_item_id", "option_id");



ALTER TABLE ONLY "menu_content"."menu_catalog_items"
    ADD CONSTRAINT "menu_catalog_items_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "menu_content"."menu_catalog_sections"
    ADD CONSTRAINT "menu_catalog_sections_order_index_key" UNIQUE ("order_index");



ALTER TABLE ONLY "menu_content"."menu_catalog_sections"
    ADD CONSTRAINT "menu_catalog_sections_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "menu_content"."menu_catalog_sections"
    ADD CONSTRAINT "menu_catalog_sections_section_id_key" UNIQUE ("section_id");



ALTER TABLE ONLY "menu_content"."menu_daily_items"
    ADD CONSTRAINT "menu_daily_items_item_id_key" UNIQUE ("item_id");



ALTER TABLE ONLY "menu_content"."menu_daily_items"
    ADD CONSTRAINT "menu_daily_items_order_index_key" UNIQUE ("order_index");



ALTER TABLE ONLY "menu_content"."menu_daily_items"
    ADD CONSTRAINT "menu_daily_items_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "menu_content"."menu_grill_catalog_items"
    ADD CONSTRAINT "menu_grill_catalog_items_item_id_key" UNIQUE ("item_id");



ALTER TABLE ONLY "menu_content"."menu_grill_catalog_items"
    ADD CONSTRAINT "menu_grill_catalog_items_order_index_key" UNIQUE ("order_index");



ALTER TABLE ONLY "menu_content"."menu_grill_catalog_items"
    ADD CONSTRAINT "menu_grill_catalog_items_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "menu_content"."menu_grill_families"
    ADD CONSTRAINT "menu_grill_families_order_index_key" UNIQUE ("order_index");



ALTER TABLE ONLY "menu_content"."menu_grill_families"
    ADD CONSTRAINT "menu_grill_families_pkey" PRIMARY KEY ("family_id");



ALTER TABLE ONLY "menu_content"."menu_price_variants"
    ADD CONSTRAINT "menu_price_variants_pkey" PRIMARY KEY ("pricing_key", "variant_id");



ALTER TABLE ONLY "menu_content"."menu_price_variants"
    ADD CONSTRAINT "menu_price_variants_pricing_key_order_index_key" UNIQUE ("pricing_key", "order_index");



ALTER TABLE ONLY "menu_content"."menu_prices"
    ADD CONSTRAINT "menu_prices_pkey" PRIMARY KEY ("pricing_key");



ALTER TABLE ONLY "menu_content"."menu_prices"
    ADD CONSTRAINT "menu_prices_pricing_key_kind_key" UNIQUE ("pricing_key", "kind");



ALTER TABLE ONLY "menu_content"."menu_profile_facts"
    ADD CONSTRAINT "menu_profile_facts_pkey" PRIMARY KEY ("profile_id", "fact_id");



ALTER TABLE ONLY "menu_content"."menu_profile_facts"
    ADD CONSTRAINT "menu_profile_facts_profile_id_order_index_key" UNIQUE ("profile_id", "order_index");



ALTER TABLE ONLY "menu_content"."menu_profile_service_settings"
    ADD CONSTRAINT "menu_profile_service_settings_pkey" PRIMARY KEY ("profile_id");



ALTER TABLE ONLY "menu_content"."menu_profiles"
    ADD CONSTRAINT "menu_profiles_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."menu_availability_overlays"
    ADD CONSTRAINT "menu_availability_overlays_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "menu_change_events_changed_by_idx" ON "app_private"."menu_change_events" USING "btree" ("changed_by", "created_at" DESC);



CREATE INDEX "menu_change_events_publish_request_idx" ON "app_private"."menu_change_events" USING "btree" ("publish_request_id", "created_at", "id");



CREATE INDEX "menu_change_events_unpublished_idx" ON "app_private"."menu_change_events" USING "btree" ("created_at", "id") WHERE ("publish_request_id" IS NULL);



CREATE INDEX "menu_publish_requests_published_hash_idx" ON "app_private"."menu_publish_requests" USING "btree" ("completed_at" DESC, "created_at" DESC) WHERE (("status" = 'succeeded'::"text") AND ("menu_content_hash" IS NOT NULL));



CREATE INDEX "menu_publish_requests_recent_publish_idx" ON "app_private"."menu_publish_requests" USING "btree" ("created_at" DESC) WHERE ("status" = ANY (ARRAY['queued'::"text", 'succeeded'::"text"]));



CREATE INDEX "menu_publish_requests_requested_by_idx" ON "app_private"."menu_publish_requests" USING "btree" ("requested_by", "created_at" DESC);



CREATE UNIQUE INDEX "menu_catalog_item_options_item_visible_name_key" ON "menu_content"."menu_catalog_item_options" USING "btree" ("catalog_item_id", "app_private"."normalize_visible_name"("name"));



CREATE INDEX "menu_catalog_items_pricing_key_idx" ON "menu_content"."menu_catalog_items" USING "btree" ("pricing_key");



CREATE UNIQUE INDEX "menu_catalog_items_section_visible_name_key" ON "menu_content"."menu_catalog_items" USING "btree" ("section_id", "app_private"."normalize_visible_name"("name"));



CREATE INDEX "menu_daily_items_pricing_key_idx" ON "menu_content"."menu_daily_items" USING "btree" ("pricing_key");



CREATE UNIQUE INDEX "menu_grill_catalog_items_family_visible_name_key" ON "menu_content"."menu_grill_catalog_items" USING "btree" ("family_id", "app_private"."normalize_visible_name"(COALESCE("variant_name", "name")));



CREATE INDEX "menu_grill_catalog_items_pricing_key_idx" ON "menu_content"."menu_grill_catalog_items" USING "btree" ("pricing_key");



CREATE UNIQUE INDEX "menu_grill_families_visible_title_key" ON "menu_content"."menu_grill_families" USING "btree" ("app_private"."normalize_visible_name"("title"));



CREATE INDEX "menu_price_variants_pricing_key_price_kind_idx" ON "menu_content"."menu_price_variants" USING "btree" ("pricing_key", "price_kind");



CREATE UNIQUE INDEX "menu_availability_overlays_unique_item" ON "public"."menu_availability_overlays" USING "btree" ("menu_id", "section_id", "item_id");



CREATE INDEX "menu_availability_overlays_updated_by_idx" ON "public"."menu_availability_overlays" USING "btree" ("updated_by");



CREATE INDEX "staff_users_default_availability_profile_id_idx" ON "public"."staff_users" USING "btree" ("default_availability_profile_id");



CREATE OR REPLACE TRIGGER "set_staff_users_updated_at" BEFORE UPDATE ON "public"."staff_users" FOR EACH ROW EXECUTE FUNCTION "public"."set_staff_users_updated_at"();



ALTER TABLE ONLY "app_private"."menu_change_events"
    ADD CONSTRAINT "menu_change_events_changed_by_fkey" FOREIGN KEY ("changed_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "app_private"."menu_change_events"
    ADD CONSTRAINT "menu_change_events_publish_request_id_fkey" FOREIGN KEY ("publish_request_id") REFERENCES "app_private"."menu_publish_requests"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "app_private"."menu_publish_requests"
    ADD CONSTRAINT "menu_publish_requests_requested_by_fkey" FOREIGN KEY ("requested_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "menu_content"."menu_catalog_item_images"
    ADD CONSTRAINT "menu_catalog_item_images_catalog_item_id_fkey" FOREIGN KEY ("catalog_item_id") REFERENCES "menu_content"."menu_catalog_items"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "menu_content"."menu_catalog_item_options"
    ADD CONSTRAINT "menu_catalog_item_options_catalog_item_id_fkey" FOREIGN KEY ("catalog_item_id") REFERENCES "menu_content"."menu_catalog_items"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "menu_content"."menu_catalog_items"
    ADD CONSTRAINT "menu_catalog_items_pricing_key_fkey" FOREIGN KEY ("pricing_key") REFERENCES "menu_content"."menu_prices"("pricing_key");



ALTER TABLE ONLY "menu_content"."menu_catalog_items"
    ADD CONSTRAINT "menu_catalog_items_section_id_fkey" FOREIGN KEY ("section_id") REFERENCES "menu_content"."menu_catalog_sections"("section_id") ON DELETE CASCADE;



ALTER TABLE ONLY "menu_content"."menu_daily_items"
    ADD CONSTRAINT "menu_daily_items_pricing_key_fkey" FOREIGN KEY ("pricing_key") REFERENCES "menu_content"."menu_prices"("pricing_key");



ALTER TABLE ONLY "menu_content"."menu_grill_catalog_items"
    ADD CONSTRAINT "menu_grill_catalog_items_family_id_fkey" FOREIGN KEY ("family_id") REFERENCES "menu_content"."menu_grill_families"("family_id");



ALTER TABLE ONLY "menu_content"."menu_grill_catalog_items"
    ADD CONSTRAINT "menu_grill_catalog_items_pricing_key_fkey" FOREIGN KEY ("pricing_key") REFERENCES "menu_content"."menu_prices"("pricing_key");



ALTER TABLE ONLY "menu_content"."menu_price_variants"
    ADD CONSTRAINT "menu_price_variants_pricing_key_price_kind_fkey" FOREIGN KEY ("pricing_key", "price_kind") REFERENCES "menu_content"."menu_prices"("pricing_key", "kind") ON DELETE CASCADE;



ALTER TABLE ONLY "menu_content"."menu_profile_facts"
    ADD CONSTRAINT "menu_profile_facts_profile_id_fkey" FOREIGN KEY ("profile_id") REFERENCES "menu_content"."menu_profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "menu_content"."menu_profile_service_settings"
    ADD CONSTRAINT "menu_profile_service_settings_profile_id_fkey" FOREIGN KEY ("profile_id") REFERENCES "menu_content"."menu_profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."menu_availability_overlays"
    ADD CONSTRAINT "menu_availability_overlays_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."staff_users"
    ADD CONSTRAINT "staff_users_default_availability_profile_id_fkey" FOREIGN KEY ("default_availability_profile_id") REFERENCES "menu_content"."menu_profiles"("id") ON UPDATE CASCADE ON DELETE SET NULL;
...
CREATE POLICY "Admins can insert staff users" ON "public"."staff_users" FOR INSERT TO "authenticated" WITH CHECK ("app_private"."can_manage_staff"());



CREATE POLICY "Admins can update staff users" ON "public"."staff_users" FOR UPDATE TO "authenticated" USING ("app_private"."can_manage_staff"()) WITH CHECK ("app_private"."can_manage_staff"());



CREATE POLICY "Menu availability overlays are publicly readable" ON "public"."menu_availability_overlays" FOR SELECT TO "authenticated", "anon" USING (true);



CREATE POLICY "Staff users can read permitted rows" ON "public"."staff_users" FOR SELECT TO "authenticated" USING ((((( SELECT "auth"."uid"() AS "uid") = "user_id") AND ("active" = true)) OR "public"."can_manage_staff"()));
...
REVOKE ALL ON FUNCTION "app_private"."add_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text", "amount" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."add_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text", "amount" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."add_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."add_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."add_grill_item"("family_id" "text", "item_id" "text", "name" "text", "variant_name" "text", "amount" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."add_grill_item"("family_id" "text", "item_id" "text", "name" "text", "variant_name" "text", "amount" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."add_grill_product"("family_id" "text", "title" "text", "item_id" "text", "variant_name" "text", "amount" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."add_grill_product"("family_id" "text", "title" "text", "item_id" "text", "variant_name" "text", "amount" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."can_edit_availability"("target_profile_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."can_edit_availability"("target_profile_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."can_edit_menu_content"() FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."can_edit_menu_content"() TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."can_manage_staff"() FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."can_manage_staff"() TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."can_publish_menu"() FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."can_publish_menu"() TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."clear_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."clear_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."clear_menu_availability_overlays"("targets" "jsonb") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."clear_menu_availability_overlays"("targets" "jsonb") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."delete_catalog_item"("section_id" "text", "item_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."delete_catalog_item"("section_id" "text", "item_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."delete_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."delete_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."delete_grill_item"("item_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."delete_grill_item"("item_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."delete_grill_product"("family_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."delete_grill_product"("family_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."generate_admin_id"("prefix" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."generate_admin_id"("prefix" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."get_admin_catalog_editor_state"() FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."get_admin_catalog_editor_state"() TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."get_admin_grill_editor_state"() FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."get_admin_grill_editor_state"() TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."get_admin_operational_state"() FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."get_admin_operational_state"() TO "authenticated";
...
GRANT ALL ON FUNCTION "app_private"."get_menu_publication_state"() TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."is_active_staff"() FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."is_active_staff"() TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."menu_availability_target_exists"("target_menu_id" "text", "target_section_id" "text", "target_item_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."menu_availability_target_exists"("target_menu_id" "text", "target_section_id" "text", "target_item_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."normalize_visible_name"("value" "text") FROM PUBLIC;



REVOKE ALL ON FUNCTION "app_private"."record_menu_change_event"("change_operation" "text", "operation_input" "jsonb", "result_message" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."record_menu_change_event"("change_operation" "text", "operation_input" "jsonb", "result_message" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."set_daily_menu"("regular_name" "text", "regular_description" "text", "vegetarian_name" "text", "vegetarian_description" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."set_daily_menu"("regular_name" "text", "regular_description" "text", "vegetarian_name" "text", "vegetarian_description" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."set_global_fixed_price"("pricing_key" "text", "amount" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."set_global_fixed_price"("pricing_key" "text", "amount" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."set_global_price_variant"("pricing_key" "text", "variant_id" "text", "amount" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."set_global_price_variant"("pricing_key" "text", "variant_id" "text", "amount" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."set_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text", "available_override" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."set_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text", "available_override" boolean) TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."set_menu_availability_overlays"("targets" "jsonb", "available_override" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."set_menu_availability_overlays"("targets" "jsonb", "available_override" boolean) TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."set_profile_service_kind"("profile_id" "text", "service_kind" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."set_profile_service_kind"("profile_id" "text", "service_kind" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."update_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."update_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."update_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."update_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."update_grill_item"("item_id" "text", "name" "text", "variant_name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."update_grill_item"("item_id" "text", "name" "text", "variant_name" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "app_private"."update_grill_product"("family_id" "text", "title" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "app_private"."update_grill_product"("family_id" "text", "title" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."add_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text", "amount" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."add_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text", "amount" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."add_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."add_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."add_grill_item"("family_id" "text", "item_id" "text", "name" "text", "variant_name" "text", "amount" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."add_grill_item"("family_id" "text", "item_id" "text", "name" "text", "variant_name" "text", "amount" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."add_grill_product"("family_id" "text", "title" "text", "item_id" "text", "variant_name" "text", "amount" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."add_grill_product"("family_id" "text", "title" "text", "item_id" "text", "variant_name" "text", "amount" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."can_edit_availability"("target_profile_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."can_edit_availability"("target_profile_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."can_edit_menu_content"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."can_edit_menu_content"() TO "authenticated";



REVOKE ALL ON FUNCTION "public"."can_manage_staff"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."can_manage_staff"() TO "authenticated";



REVOKE ALL ON FUNCTION "public"."can_publish_menu"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."can_publish_menu"() TO "authenticated";



REVOKE ALL ON FUNCTION "public"."clear_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."clear_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."clear_menu_availability_overlays"("targets" "jsonb") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."clear_menu_availability_overlays"("targets" "jsonb") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."complete_menu_publish_request"("request_id" bigint, "publish_status" "text", "publish_message" "text", "vercel_status_code" integer, "vercel_job_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."complete_menu_publish_request"("request_id" bigint, "publish_status" "text", "publish_message" "text", "vercel_status_code" integer, "vercel_job_id" "text") TO "service_role";



REVOKE ALL ON FUNCTION "public"."delete_catalog_item"("section_id" "text", "item_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."delete_catalog_item"("section_id" "text", "item_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."delete_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."delete_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."delete_grill_item"("item_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."delete_grill_item"("item_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."delete_grill_product"("family_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."delete_grill_product"("family_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."get_admin_operational_state"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_admin_operational_state"() TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."menu_availability_target_exists"("target_menu_id" "text", "target_section_id" "text", "target_item_id" "text") FROM PUBLIC;



REVOKE ALL ON FUNCTION "public"."reserve_menu_publish_request"("user_id" "uuid", "cooldown_seconds" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."reserve_menu_publish_request"("user_id" "uuid", "cooldown_seconds" integer) TO "service_role";



REVOKE ALL ON FUNCTION "public"."set_daily_menu"("regular_name" "text", "regular_description" "text", "vegetarian_name" "text", "vegetarian_description" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."set_daily_menu"("regular_name" "text", "regular_description" "text", "vegetarian_name" "text", "vegetarian_description" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."set_global_fixed_price"("pricing_key" "text", "amount" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."set_global_fixed_price"("pricing_key" "text", "amount" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."set_global_price_variant"("pricing_key" "text", "variant_id" "text", "amount" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."set_global_price_variant"("pricing_key" "text", "variant_id" "text", "amount" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."set_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text", "available_override" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."set_menu_availability_overlay"("menu_id" "text", "section_id" "text", "item_id" "text", "available_override" boolean) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."set_menu_availability_overlays"("targets" "jsonb", "available_override" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."set_menu_availability_overlays"("targets" "jsonb", "available_override" boolean) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."set_profile_service_kind"("profile_id" "text", "service_kind" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."set_profile_service_kind"("profile_id" "text", "service_kind" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."set_staff_users_updated_at"() FROM PUBLIC;



REVOKE ALL ON FUNCTION "public"."update_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."update_catalog_item"("section_id" "text", "item_id" "text", "name" "text", "description" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."update_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."update_catalog_item_option"("section_id" "text", "item_id" "text", "option_id" "text", "name" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."update_grill_item"("item_id" "text", "name" "text", "variant_name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."update_grill_item"("item_id" "text", "name" "text", "variant_name" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."update_grill_product"("family_id" "text", "title" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."update_grill_product"("family_id" "text", "title" "text") TO "authenticated";



REVOKE ALL ON TABLE "public"."menu_availability_overlays" FROM "anon", "authenticated", "service_role";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."menu_availability_overlays" TO "service_role";



GRANT SELECT("menu_id") ON TABLE "public"."menu_availability_overlays" TO "anon";
GRANT SELECT("menu_id") ON TABLE "public"."menu_availability_overlays" TO "authenticated";



GRANT SELECT("section_id") ON TABLE "public"."menu_availability_overlays" TO "anon";
GRANT SELECT("section_id") ON TABLE "public"."menu_availability_overlays" TO "authenticated";



GRANT SELECT("item_id") ON TABLE "public"."menu_availability_overlays" TO "anon";
GRANT SELECT("item_id") ON TABLE "public"."menu_availability_overlays" TO "authenticated";



GRANT SELECT("available_override") ON TABLE "public"."menu_availability_overlays" TO "anon";
GRANT SELECT("available_override") ON TABLE "public"."menu_availability_overlays" TO "authenticated";



REVOKE ALL ON TABLE "public"."staff_users" FROM "anon", "authenticated", "service_role";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."staff_users" TO "service_role";
...
insert into menu_content.menu_daily_items (
  ...
  ('1', 'menu-del-dia', 'Filet de merluza rebozado con guarnición.', null, true, 'menu-del-dia', 0),
...
begin
  ...
  if exists (
    ...
    where (table_schema = 'public' and table_name = 'menu_availability_overlays' and column_name = 'group_id')
      or (table_schema = 'menu_content' and table_name = 'menu_catalog_items' and column_name = 'group_id')
      or (
        table_schema = 'menu_content'
        and table_name in ('menu_catalog_items', 'menu_daily_items', 'menu_grill_catalog_items')
  ...
  if exists (
    ...
    having min(image.order_index) <> 0 or max(image.order_index) + 1 <> count(*)
  ) then
  ...
  select app_private.get_menu_publication_content_hash() into actual_hash;

  if actual_hash <> '2db0c8dc46283c2f3ec1fe8ebd630693' then
